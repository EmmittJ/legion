...
- Never commit unreviewed work — only accept work that has passed through Belial
...
Use `memory:insight:create` when you notice a recurring pattern — commit conventions that keep
